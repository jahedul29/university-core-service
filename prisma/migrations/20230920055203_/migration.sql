...
CREATE TABLE "student_payments" (
    ...
    "partialPaidAmount" INTEGER DEFAULT 0,
...
-- AddForeignKey
ALTER TABLE "student_payments" ADD CONSTRAINT "student_payments_academicSemesterId_fkey" FOREIGN KEY ("academicSemesterId") REFERENCES "academic_semesters"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
